...
<div class="main">
	<div class="procedure">
		<ul>
			...
			<li><span class="aOrange">成功发布房源</span><div class="probg1">4</div></li>
			<div class="clear"></div>
		</ul>
	</div></br>
	...
	<div class="tsconT">
		<img src="http://assets.muniao.com/assets/2013/image/user/bgts6.jpg" width="30" height="30" align="absmiddle" />
		<strong>提示信息&nbsp;</strong>恭喜您成为新一代房东
	</div>
	<div class="tscon1">
		<span >
		<div class="tsconbtn">您可以：<a href="{{url('/')}}"><font color="red">回首页</font></a></div>
		</span>
	</div>
</br></br></br></br>
</div>
