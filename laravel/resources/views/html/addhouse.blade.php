...
<div class="main">
	<div class="procedure">
		<ul>
			...
			<li><span>填写时间价格</span><div class="probg">3</div></li>
	...
	<div class="oneself">
			...
			<table width="948" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right" height="50" valign="middle" width="200"><span class="aRed">*</span>公寓名称：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="house_address" id="house_address" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>可住人数：</td>
					<td colspan="3" align="left" height="50" valign="middle">
					<!-- <select name="number" id="number" class="oneselfinput">
					...
					<input type="text" name="number" class="oneselfinput" />
					</td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>房屋面积：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="house_size" id="house_size" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>房屋地址：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="house_postion" id="house_postion" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>房屋描述：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="house_desc" id="house_desc" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>房屋类型：&nbsp;&nbsp;</td>
					<td colspan="3" align="left" height="50" valign="middle">&nbsp;&nbsp;
					<input name="property_class" value="小区"type="radio">小区&nbsp;&nbsp;<input name="property_class" value="公寓" type="radio">公寓&nbsp;&nbsp;<input name="property_class" value="别墅" type="radio">别墅&nbsp;&nbsp;</td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>联系人：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="linkman" id="linkman" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
					<td align="right" height="50" valign="middle" width="71"><span class="aRed">*</span>联系电话：</td>
					<td colspan="3" align="left" height="50" valign="middle"><input name="phone" id="phone" class="oneselfinput" type="text"></td>
					<td align="left" height="50" valign="middle" width="200">&nbsp;</td>
				</tr>
				<tr>
				<td>
