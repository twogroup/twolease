													...
													<tr>
														...
														<td align="center" style="vertical-align:middle;">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																...
																<a class="ui-pg-div ui-inline-save" href="index.php?r=community/pass&id=<?php echo $key['id'] ?>">
																	<i class="ui-icon ui-icon-disk"></i>
																</a>
																<a class="ui-pg-div ui-inline-cancel" href="index.php?r=community/fail&id=<?php echo $key['id'] ?>">
																	<i class="ui-icon ui-icon-cancel"></i>
																</a>
																<!-- <a class="blue" href="index.php?r=community/select&id=<?php echo $key['id'] ?>">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>
																<a class="green" href="index.php?r=community/update&id=<?php echo $key['id'] ?>">
																	<i class="icon-pencil bigger-130"></i> -->
																</a>
																<a class="red" href="index.php?r=community/delete&id=<?php echo $key['id'] ?>">
