											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<?php foreach($ast as $key):?>
													<tr>
														...
														<td>
															<a href="index.php?r=rent/details&detailsid=<?php echo $key['rent_id']?>"><?php echo $key['lname']?></a>
														</td>
														<td><img src="D:/WWW/zulin2/twolease/laravel/public/uploads/<?php echo $key['photo']?>" width="50px" height="30px"></td>
