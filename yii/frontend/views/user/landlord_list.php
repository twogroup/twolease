													...
													<tr>
														...
														<td align="center" style="vertical-align:middle;">
															<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
																<a class="blue" href="index.php?r=user/selectlandlord&id=<?php echo $key['id']?>">
																	<i class="icon-zoom-in bigger-130"></i>
																</a>

																<a class="green" href="index.php?r=user/updatelandlord&id=<?php echo $key['id']?>">
																	<i class="icon-pencil bigger-130"></i>
																</a>

																<a class="red" href="index.php?r=user/deletelandlord&id=<?php echo $key['id']?>">
